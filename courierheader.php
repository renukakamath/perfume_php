...
<body>
	<a href="courier_viewassigned.php">View Assign Orders</a>
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            <li><a class="nav-link scrollto active" href="courier_home.php">Home</a></li>
            <li><a class="nav-link scrollto" href="courier_viewassigned.php">View Assigned Orders</a></li>
